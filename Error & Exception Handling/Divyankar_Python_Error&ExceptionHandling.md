...
![shortcut](Multiple_Exception.jpg)

Now, let's take a look at an example to better understand this.

![shortcut](Multiple_Exception_Example.jpg)

The output of the aforementioned program is given below:

![shortcut](Multiple_Exception_Example_Output.jpg)
...
![shortcut](Else_example.jpg)

The output of the aforementioned program is given below:

![shortcut](Else_example_output.jpg)
...
![shortcut](Finally_example.jpg)

The output of the aforementioned program is given below:

![shortcut](Finally_example_output.jpg)
...
![shortcut](User_defined_example.jpg)

The output of the aforementioned program is given below:

![shortcut](User_defined_example_output.jpg)
